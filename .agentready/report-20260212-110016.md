...
**Path**: `/Users/ddahlem/Documents/repos/trusty/opendatahub-io/trustyai-explainability`
**Branch**: `main` | **Commit**: `6a91478c`
...
**Evidence**:
- CI config found: .github/workflows/security.yml, .github/workflows/tests.yml, .github/workflows/agentready-assessment.yml, .github/workflows/trivy-scan.yaml, .github/workflows/CI.yaml, .github/workflows/test.yaml, .github/workflows/sync-branch-incubation.yaml, .github/workflows/sync-branch-stable.yaml
...
- **Repository Snapshot**: 6a91478c9ad84595233d1f29805466f420f98a46
- **Assessment Duration**: 0.6s
